    ...
    public partial class frm_ExportExcel : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_Export_Click(object sender, EventArgs e)
        {
            ...
            if (Loai == "AE")
            {
                ...
                TableToExcel_AE_Error(System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments) + "\\ExportExcel.xlsx", "AE");
            }
            else if (Loai == "AT")
            {
                TableToExcel_AT(System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments) +"\\ExportExcel.xlsx", "AT");
            }
        ...
        public bool TableToExcel_AE(String strfilename, string TruongCoDinh)
        {
            try
            {
                ...
                saveFileDialog1.FileName = cbb_Batch.Text + "_AE";
        ...
        public bool TableToExcel_AE_Error(String strfilename, string TruongCoDinh)
        {
            try
            {
                dataGridView1.DataSource = null;
                dataGridView1.DataSource = Global.db.ExportExcel_AE_Error(cbb_Batch.Text);
                Microsoft.Office.Interop.Excel.Application App = new Microsoft.Office.Interop.Excel.Application();
                Microsoft.Office.Interop.Excel.Workbook book = App.Workbooks.Open(strfilename, 0, true, 5, "", "", false,
                    Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "", true, false, 0, true, false, false);
                Microsoft.Office.Interop.Excel.Sheets _sheet = (Microsoft.Office.Interop.Excel.Sheets)book.Sheets;
                ...
                saveFileDialog1.Title = "Save Excel Files";
                saveFileDialog1.Filter = "Excel files (*.xlsx)|*.xlsx";
                saveFileDialog1.FileName = cbb_Batch.Text + "_AE_Error";
                saveFileDialog1.RestoreDirectory = true;
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    book.SaveCopyAs(saveFileDialog1.FileName);
        ...
        public bool TableToExcel_AT(String strfilename, string TruongCoDinh)
        {
            try
            {
                ...
                foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    {
                        if (dr.Cells[7].Value.ToString() == "YOHAKU" ||
                            dr.Cells[7].Value.ToString() == "SAKUJYO" ||
                            dr.Cells[7].Value.ToString() == "KAKISONJI" ||
                            dr.Cells[7].Value.ToString() == "MISIYO")
                        {
                            wrksheet.Cells[h, 4] = ""; //3
                            wrksheet.Cells[h, 5] = ""; //4
                            wrksheet.Cells[h, 6] = ""; //5
                        }
                        else
                        {
                            wrksheet.Cells[h, 4] = dr.Cells[3].Value != null ? dr.Cells[3].Value.ToString() : ""; //3
                    ...
                    if (dr.Cells[7].Value != null)
                    {
                        if (dr.Cells[7].Value.ToString() == "KAKISONJI")
                        {
                            wrksheet.Cells[h, 12] = "K"; //11
                        }
                        else if (dr.Cells[7].Value.ToString() == "MISIYO")
                        {
                            wrksheet.Cells[h, 12] = "M"; //11
                        }
                        else
                        {
                            wrksheet.Cells[h, 12] = ""; //11
                        }
                    }
                    else
                    {
                    ...
                    if (!string.IsNullOrEmpty(dr.Cells[20].Value.ToString()))
                    {
                        ...
                        switch (temp[1])
                        {
                            case "SOKA":
                                ...
                                break;
                            case "TUKU":
                                wrksheet.Cells[h, 13] = "TA2";
                                break;
                            case "SIMO":
                                wrksheet.Cells[h, 13] = "TA8";
                                break;
                            case "YAMA":
                                wrksheet.Cells[h, 13] = "TA3";
                                break;
                            case "TONO":
                                wrksheet.Cells[h, 13] = "TA5";
                                break;
                            case "KAMA":
                                wrksheet.Cells[h, 13] = "TA4";
                                break;
                            case "BUTU":
                                wrksheet.Cells[h, 13] = "TA6";
                                break;
                            default:
                                wrksheet.Cells[h, 13] = dr.Cells[12].Value != null ? dr.Cells[12].Value.ToString() : ""; //12
                                break;
                ...
                saveFileDialog1.Title = "Save Excel Files";
                saveFileDialog1.Filter = "Excel files (*.xlsx)|*.xlsx";
                saveFileDialog1.FileName = cbb_Batch.Text +"_AT";
                saveFileDialog1.RestoreDirectory = true;
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    book.SaveCopyAs(saveFileDialog1.FileName);
