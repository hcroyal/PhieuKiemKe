    ...
    public partial class frm_Check_DeSo : XtraForm
    {
        ...
        private void Load_DeSo(string strBatch, string idimage)
        {
            ...
            if (Global.LoaiPhieu == "AE")
            {
                ...
                uc_AE2.txt_TruongSo02.Text = deso[0].Truong_02;
                uc_AE2.txt_TruongSo03.Text = deso[0].Truong_03;
                uc_AE2.txt_TruongSo04.Text = deso[0].Truong_04;
                uc_AE2.txt_TruongSo05.Text = deso[0].Truong_05;

                uc_AE2.uc_AE_Rows1.txt_TruongSo09.Text = deso[0].Truong_09;
                uc_AE2.uc_AE_Rows2.txt_TruongSo09.Text = deso[1].Truong_09;
                uc_AE2.uc_AE_Rows3.txt_TruongSo09.Text = deso[2].Truong_09;
                uc_AE2.uc_AE_Rows4.txt_TruongSo09.Text = deso[3].Truong_09;
                uc_AE2.uc_AE_Rows5.txt_TruongSo09.Text = deso[4].Truong_09;
                uc_AE2.uc_AE_Rows6.txt_TruongSo09.Text = deso[5].Truong_09;
                uc_AE2.uc_AE_Rows7.txt_TruongSo09.Text = deso[6].Truong_09;
                uc_AE2.uc_AE_Rows8.txt_TruongSo09.Text = deso[7].Truong_09;
                uc_AE2.uc_AE_Rows9.txt_TruongSo09.Text = deso[8].Truong_09;
                uc_AE2.uc_AE_Rows10.txt_TruongSo09.Text = deso[9].Truong_09;
            ...
            else if (Global.LoaiPhieu == "AT")
            {
                ...
                tabcontrol_DeSo2.SelectedTabPage = tp_AE_DeSo2;
                uC_AT2.txt_TruongSo02.Text = deso[0].Truong_02;
                uC_AT2.txt_TruongSo03.Text = deso[0].Truong_03;
                uC_AT2.txt_TruongSo04.Text = deso[0].Truong_04;
                uC_AT2.txt_TruongSo05.Text = deso[0].Truong_05;

                uC_AT2.uc_AT_Rows1.txt_TruongSo07.Text = deso[0].Truong_07;
                uC_AT2.uc_AT_Rows1.txt_TruongSo08.Text = deso[0].Truong_08;
                uC_AT2.uc_AT_Rows1.txt_TruongSo09.Text = deso[0].Truong_09;
                uC_AT2.uc_AT_Rows1.txt_TruongSo10.Text = deso[0].Truong_10;

                uC_AT2.uc_AT_Rows2.txt_TruongSo07.Text = deso[1].Truong_07;
                uC_AT2.uc_AT_Rows2.txt_TruongSo08.Text = deso[1].Truong_08;
                uC_AT2.uc_AT_Rows2.txt_TruongSo09.Text = deso[1].Truong_09;
                uC_AT2.uc_AT_Rows2.txt_TruongSo10.Text = deso[1].Truong_10;

                uC_AT2.uc_AT_Rows3.txt_TruongSo07.Text = deso[2].Truong_07;
                uC_AT2.uc_AT_Rows3.txt_TruongSo08.Text = deso[2].Truong_08;
                uC_AT2.uc_AT_Rows3.txt_TruongSo09.Text = deso[2].Truong_09;
                uC_AT2.uc_AT_Rows3.txt_TruongSo10.Text = deso[2].Truong_10;

                uC_AT2.uc_AT_Rows4.txt_TruongSo07.Text = deso[3].Truong_07;
                uC_AT2.uc_AT_Rows4.txt_TruongSo08.Text = deso[3].Truong_08;
                uC_AT2.uc_AT_Rows4.txt_TruongSo09.Text = deso[3].Truong_09;
                uC_AT2.uc_AT_Rows4.txt_TruongSo10.Text = deso[3].Truong_10;

                uC_AT2.uc_AT_Rows5.txt_TruongSo07.Text = deso[4].Truong_07;
                uC_AT2.uc_AT_Rows5.txt_TruongSo08.Text = deso[4].Truong_08;
                uC_AT2.uc_AT_Rows5.txt_TruongSo09.Text = deso[4].Truong_09;
                uC_AT2.uc_AT_Rows5.txt_TruongSo10.Text = deso[4].Truong_10;

                uC_AT2.uc_AT_Rows6.txt_TruongSo07.Text = deso[5].Truong_07;
                uC_AT2.uc_AT_Rows6.txt_TruongSo08.Text = deso[5].Truong_08;
                uC_AT2.uc_AT_Rows6.txt_TruongSo09.Text = deso[5].Truong_09;
                uC_AT2.uc_AT_Rows6.txt_TruongSo10.Text = deso[5].Truong_10;

                uC_AT2.uc_AT_Rows7.txt_TruongSo07.Text = deso[6].Truong_07;
                uC_AT2.uc_AT_Rows7.txt_TruongSo08.Text = deso[6].Truong_08;
                uC_AT2.uc_AT_Rows7.txt_TruongSo09.Text = deso[6].Truong_09;
                uC_AT2.uc_AT_Rows7.txt_TruongSo10.Text = deso[6].Truong_10;

                uC_AT2.uc_AT_Rows8.txt_TruongSo07.Text = deso[7].Truong_07;
                uC_AT2.uc_AT_Rows8.txt_TruongSo08.Text = deso[7].Truong_08;
                uC_AT2.uc_AT_Rows8.txt_TruongSo09.Text = deso[7].Truong_09;
                uC_AT2.uc_AT_Rows8.txt_TruongSo10.Text = deso[7].Truong_10;

                uC_AT2.uc_AT_Rows9.txt_TruongSo07.Text = deso[8].Truong_07;
                uC_AT2.uc_AT_Rows9.txt_TruongSo08.Text = deso[8].Truong_08;
                uC_AT2.uc_AT_Rows9.txt_TruongSo09.Text = deso[8].Truong_09;
                uC_AT2.uc_AT_Rows9.txt_TruongSo10.Text = deso[8].Truong_10;

                uC_AT2.uc_AT_Rows10.txt_TruongSo07.Text = deso[9].Truong_07;
                uC_AT2.uc_AT_Rows10.txt_TruongSo08.Text = deso[9].Truong_08;
                uC_AT2.uc_AT_Rows10.txt_TruongSo09.Text = deso[9].Truong_09;
                uC_AT2.uc_AT_Rows10.txt_TruongSo10.Text = deso[9].Truong_10;
        ...
        private void tabcontrol_DeSo2_Click(object sender, EventArgs e)
        {
            ...
            //    tabcontrol_DeSo1.SelectedTabPage = tp_AE_DeSo1;
            //else if (tabcontrol_DeSo2.SelectedTabPage == tp_AT_DeSo2)
            //    tabcontrol_DeSo1.SelectedTabPage = tp_AT_DeSo1;
        }
